    ...
    <div className="min-h-screen py-16 flex items-center justify-center">
      <Card className="max-w-lg mx-auto">
        <CardContent className="p-12 text-center space-y-4">
          ...
          <h1 className="text-3xl font-bold">Ghibli AI</h1>
          <p className="text-muted-foreground">Ghibli-style AI transformation is coming soon. Turn your photos into Studio Ghibli inspired art.</p>
